...
public class Prueba3 implements Aeropuerto
 { 

public static void main(String[] args) {

	Prueba3 aeropuerto = new Prueba3();

    // Creamos algunos usuarios
    User user1 = new User("Juan", "12345", "IB234", "67", false);
    ...
    aeropuerto.moveUserToBoardingQueue(user1);
    aeropuerto.moveUserToBoardingQueue(user2);
    aeropuerto.moveUserToBoardingQueue(user3);
    aeropuerto.moveUserToBoardingQueue(user4);
    aeropuerto.moveUserToBoardingQueue(user5);
...
public Prueba3(String string, String string2, String string3, String string4, boolean b) {
...
public void moveUserToBoardingQueue(User user) {
    if (commercialZone.remove(user)) {
        ...
        throw new IllegalStateException("El usuario no esta en la zona de espera.");
    }
}
