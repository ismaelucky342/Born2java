...
public class AeropuertoUDIMA implements Aeropuerto
 { 

public static void main(String[] args) {

	AeropuertoUDIMA aeropuerto = new AeropuertoUDIMA();
  ...
  //para las diferentes pruebas modificaremos el codigo añadiendo aeropuerto. y la accion a probar 
...
public AeropuertoUDIMA(String string, String string2, String string3, String string4, boolean b) {
    
}

public AeropuertoUDIMA() {
    
}

public void register(AeropuertoUDIMA user1) {
